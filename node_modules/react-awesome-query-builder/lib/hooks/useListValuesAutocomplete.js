...
var useListValuesAutocomplete = function useListValuesAutocomplete(_ref, _ref2) {
  ...
  var onChange = /*#__PURE__*/function () {
    var _ref7 = (0, _asyncToGenerator2["default"])( /*#__PURE__*/_regenerator["default"].mark(function _callee4(_e, option) {
      var newSelectedListValues, newSelectedValues, v;
      return _regenerator["default"].wrap(function _callee4$(_context4) {
        while (1) {
          switch (_context4.prev = _context4.next) {
            ...
            case 6:
              if (option && option.specialValue == "LOADING_MORE") {
                isSelectedLoadMore.current = true;
              } else {
                if (multiple) {
                  newSelectedListValues = option.map(function (o) {
  ...
  var extendOptions = function extendOptions(options, params) {
